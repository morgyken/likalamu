                            ...
                            <article class="blog_style1";">
                                ...
                                <div class="card-body col-md-10" style="padding:20px; align: center">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <table class="table table-hover" style="margin-left:20px">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td class="col-md-1 text-center"> {{ Session::get('price')}}</td>
                                                                <td class="col-md-1 text-center">{{ Session::get('price')}}</td>


                                                            </tr>
                                                            <?php
                                                                    $tax1 = number_format((4/100) * Session::get('price'),2);
                                                                    $tax2 = number_format((3/100) * Session::get('price'),2)
                                                                ?>
                                                            <tr>
                                                            ...
                                                            <tr>
                                                                ...
                                                                $taxes = (3/100) * Session::get('price') + (4/100) * Session::get('price')
                                                                ?>
                                                                <p>
                                                                    <strong>Tax: </strong>
                                                                </p></td>
                                                            ...
                                                            <tr>
                                                                 <?php
                                                                $total =Session::get('price') +  (3/100) * Session::get('price') + (4/100) * Session::get('price');
                                                    ...
                                                    <form method="get" action="{{route('get.paypal', ['price' => $total]) }}">
                                                        <input type="hidden" name="_token" value="{{ csrf_token() }}">

                                                        <button type="submit" class="btn btn-success btn-lg btn-block">
                                                      USD ($){{ $total  }}  Pay Now   <span class="glyphicon glyphicon-chevron-right"></span>
                                                    </button>
                                                    </form>
                                                    </td>
                                                </div>
